 ...
 * avendole scritte nel posto giusto. Nessuna dipendenza esterna: fa
 * esattamente quello che serve e niente di piu'.
 *
 * Le variabili gia' presenti nell'ambiente vincono sul file, cosi' si puo'
